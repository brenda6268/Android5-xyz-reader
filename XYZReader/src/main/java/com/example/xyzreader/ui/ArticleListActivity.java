...
public class ArticleListActivity extends AppCompatActivity implements
    ...
    private void refresh() {
      //  startService(new Intent(this, UpdaterService.class));
        //br adding checking online state
        if (checkNetworkState()) {
            startService(new Intent(this, UpdaterService.class));
        } else {
            CoordinatorLayout parentView = (CoordinatorLayout) findViewById(R.id.coordinator);
            Snackbar.make(parentView, R.string.snackbar_message, Snackbar.LENGTH_INDEFINITE)
                    .setAction(R.string.snackbar_tryAgain, new View.OnClickListener() {
                        @Override
          ...
          //-- pick color from bitmap
            ...
            Picasso.get().load(mCursor.getString(ArticleLoader.Query.THUMB_URL)).into(new Target() {
                ...
                public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
                    ...
                    int bgColor = p.getMutedColor(0xff7f7f);
